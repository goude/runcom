...
color00="9/3/0" # Base 00 - Black
color01="db/2d/20" # Base 08 - Red
color02="1/a2/52" # Base 0B - Green
color03="fd/ed/2" # Base 0A - Yellow
color04="1/a0/e4" # Base 0D - Blue
...
color_background="9/3/0" # Base 00
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg a5a2a2 # foreground
