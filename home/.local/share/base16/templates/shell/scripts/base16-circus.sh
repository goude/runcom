...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg a7a7a7 # foreground
  printf $printf_template_custom Ph 191919 # background
  ...
  printf $printf_template_custom Pm 191919 # cursor text
else
