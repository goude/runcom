...
color02="0/74/0" # Base 0B - Green
color03="82/6b/28" # Base 0A - Yellow
color04="0/0/ff" # Base 0D - Blue
color05="a9/d/91" # Base 0E - Magenta
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 404040 # foreground
  printf $printf_template_custom Ph ffffff # background
  printf $printf_template_custom Pi 404040 # bold color
  printf $printf_template_custom Pj c0c0c0 # selection color
  printf $printf_template_custom Pk 404040 # selected text color
  printf $printf_template_custom Pl 404040 # cursor
