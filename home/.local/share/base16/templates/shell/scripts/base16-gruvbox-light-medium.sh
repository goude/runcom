...
color01="9d/0/6" # Base 08 - Red
color02="79/74/e" # Base 0B - Green
color03="b5/76/14" # Base 0A - Yellow
color04="7/66/78" # Base 0D - Blue
...
color16="af/3a/3" # Base 09
color17="d6/5d/e" # Base 0F
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 504945 # foreground
