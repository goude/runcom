...
color01="ff/0/0" # Base 08 - Red
color02="33/ff/0" # Base 0B - Green
color03="ff/0/99" # Base 0A - Yellow
color04="0/66/ff" # Base 0D - Blue
color05="cc/0/ff" # Base 0E - Magenta
color06="0/ff/ff" # Base 0C - Cyan
...
color16="ff/99/0" # Base 09
color17="33/0/ff" # Base 0F
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg d0d0d0 # foreground
