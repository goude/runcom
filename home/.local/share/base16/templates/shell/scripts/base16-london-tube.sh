...
color02="0/85/3e" # Base 0B - Green
color03="ff/d2/4" # Base 0A - Yellow
color04="0/9d/dc" # Base 0D - Blue
color05="98/0/5d" # Base 0E - Magenta
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg d9d8d8 # foreground
