...
color01="dd/9/7" # Base 08 - Red
color02="1f/b7/14" # Base 0B - Green
color03="fb/f3/5" # Base 0A - Yellow
color04="0/0/d3" # Base 0D - Blue
color05="47/0/a5" # Base 0E - Magenta
color06="2/ab/ea" # Base 0C - Cyan
...
color_background="0/0/0" # Base 00
color_cursor="c0/c0/c0" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg c0c0c0 # forground
  printf $printf_template_custom Ph 000000 # background
  printf $printf_template_custom Pi c0c0c0 # bold color
  printf $printf_template_custom Pj 404040 # selection color
  printf $printf_template_custom Pk c0c0c0 # selected text color
  printf $printf_template_custom Pl c0c0c0 # cursor
