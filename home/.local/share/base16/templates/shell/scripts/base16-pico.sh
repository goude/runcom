...
color01="ff/0/4d" # Base 08 - Red
color02="0/e7/56" # Base 0B - Green
...
color08="0/87/51" # Base 03 - Bright Black
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 5f574f # forground
  printf $printf_template_custom Ph 000000 # background
  printf $printf_template_custom Pi 5f574f # bold color
  printf $printf_template_custom Pj 7e2553 # selection color
  printf $printf_template_custom Pk 5f574f # selected text color
  printf $printf_template_custom Pl 5f574f # cursor
