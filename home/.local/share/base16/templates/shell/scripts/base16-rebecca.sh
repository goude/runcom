...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg f1eff8 # forground
  printf $printf_template_custom Ph 292a44 # background
  printf $printf_template_custom Pi f1eff8 # bold color
  printf $printf_template_custom Pj 383a62 # selection color
  printf $printf_template_custom Pk f1eff8 # selected text color
  printf $printf_template_custom Pl f1eff8 # cursor
  printf $printf_template_custom Pm 292a44 # cursor text
else
