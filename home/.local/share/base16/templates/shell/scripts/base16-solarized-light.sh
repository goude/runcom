...
color02="85/99/0" # Base 0B - Green
color03="b5/89/0" # Base 0A - Yellow
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 586e75 # foreground
