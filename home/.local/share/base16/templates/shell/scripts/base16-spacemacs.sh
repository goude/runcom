...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg a3a3a3 # foreground
  printf $printf_template_custom Ph 1f2022 # background
  printf $printf_template_custom Pi a3a3a3 # bold color
  printf $printf_template_custom Pj 444155 # selection color
  printf $printf_template_custom Pk a3a3a3 # selected text color
  printf $printf_template_custom Pl a3a3a3 # cursor
