...
color01="ff/0/86" # Base 08 - Red
color02="0/c9/18" # Base 0B - Green
color03="ab/a8/0" # Base 0A - Yellow
color04="37/77/e6" # Base 0D - Blue
color05="ad/0/a1" # Base 0E - Magenta
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph 151515 # background
