...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(custom_user dir dir_writable pyenv vcs)
...
# for code ({000..030}) print -P -- "$code: %F{$code}This is how your text would look like%f"
POWERLEVEL9K_CUSTOM_USER_FOREGROUND='000'
POWERLEVEL9K_CUSTOM_USER_BACKGROUND='019'
...
POWERLEVEL9K_PYENV_BACKGROUND='020'
